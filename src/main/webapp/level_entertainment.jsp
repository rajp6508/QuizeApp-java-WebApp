...
.card.easy { background-color: #4CAF50; }   
.card.medium { background-color: #FF9800; } 
.card.hard { background-color: #F44336; }   
        ...
        <div class="cards-section" id="domainCards">
            <%
                ...
                try {
                    ...
                    String sql = "SELECT DISTINCT domain FROM questions WHERE category='Entertainment'";
